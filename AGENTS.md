...
为唯一入口。当前 J0–J3 已完成，下一阶段为 APP 侧 E0；后端 Phase 5 的 Application 主记录及
`resumeContentHashSnapshot` 契约已接通，但 Interview、Note、Reminder 与本地通知仍按后续 S4/S5
推进，不得因 J3 完成而提前混入其他阶段。
