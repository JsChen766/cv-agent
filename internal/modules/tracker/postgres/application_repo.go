...
a.jd_title_snapshot, a.resume_title_snapshot, a.delivery_method, a.target_url,
...
func scanApplication(row pgx.Row) (domain.Application, error) {
	...
	err := row.Scan(
		...
		&a.JdTitleSnapshot, &a.ResumeTitleSnapshot, &a.DeliveryMethod, &a.TargetURL,
...
INSERT INTO applications (
    ...
    resume_title_snapshot, delivery_method, target_url, applied_at, status,
...
func (r *ApplicationRepository) Insert(ctx context.Context, tx pgx.Tx, a domain.Application) error {
	_, err := tx.Exec(ctx, insertApplication,
		...
		a.ResumeTitleSnapshot, string(a.DeliveryMethod), a.TargetURL, a.AppliedAt,
...
UPDATE applications SET
    ...
    delivery_method = $12, target_url = $13, applied_at = $14, status = $15,
    pending_confirmation = $16, company_business = $17, role_summary = $18,
    company_culture = $19, rejection_reason = $20
...
func (r *ApplicationRepository) UpdateAggregate(ctx context.Context, tx pgx.Tx, a domain.Application) error {
	tag, err := tx.Exec(ctx, updateApplication,
		...
		a.JdTitleSnapshot, a.ResumeTitleSnapshot, string(a.DeliveryMethod),
		a.TargetURL, a.AppliedAt, string(a.Status), a.PendingConfirmation,
		a.CompanyBusiness, a.RoleSummary, a.CompanyCulture, a.RejectionReason,
	)
	if err != nil {
		return err
