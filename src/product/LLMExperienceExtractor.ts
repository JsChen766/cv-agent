...
const SYSTEM_PROMPT = [
  ...
  "- project: A specific project or initiative. Fields: title, projectName, projectRole, techStack, projectUrl, responsibilities, outcomes, metrics, content, confidence",
