      ...
      return {
        ...
        actionResult: {
          ...
          metadata: {
            ...
            criticReviewId: result.editorialCriticReview?.reviewId,
            criticItemCount: result.editorialCriticReview?.summary.totalItems,
            criticPatchSuggestionCount: result.criticPatchSuggestions.length,
          },
        },
